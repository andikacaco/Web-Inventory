...
class Barang extends CI_Controller
{
	...
	public function create_action()
	{
		...
		if ($this->db->trans_status() === FALSE) {
			...
			$data_output = array('sukses' => 'iya', 'pesan' => 'Berhasil Input Data Barang');
		}
	...
	public function update_action()
	{
		...
		if ($this->db->trans_status() === FALSE) {
			...
			$this->db->trans_commit();
			$data_output = array('sukses' => 'ya', 'pesan' => 'Berhasil Updata Data Barang');
		}
	...
	public function soft_delete_data()
	{
		...
		if ($this->db->trans_status() === FALSE) {
			...
			$this->db->trans_commit();
			$data_output = array('sukses' => 'iya', 'pesan' => 'Berhasil Hapus Data Barang');
		}
